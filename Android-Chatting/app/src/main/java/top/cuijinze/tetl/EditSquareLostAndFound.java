...
public class EditSquareLostAndFound extends AppCompatActivity {
        ...
        publish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(content!=null && type!=null){
                    AlertDialog.Builder dialog = new AlertDialog.Builder(EditSquareLostAndFound.this)
                            ...
                            .setPositiveButton("发布", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    /*定义进度条对话框*/
                                    ProgressDialog ProDialog = new ProgressDialog(EditSquareLostAndFound.this);
                                        ...
                                        public void run() {
                                            try {
                                                ...
                                                Connection connection= DriverManager.getConnection("jdbc:mysql://1.15.60.193:3306/Android?useUnicode=true&characterEncoding=utf8",
                                                        "root","cuijinze@123456");//加入后面的一串是为了解决插入数据库时的中文乱码
                            ...
                            .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(EditSquareLostAndFound.this,"取消发布，重新编辑",Toast.LENGTH_SHORT).show();
                                }
                            })
                            .setCancelable(false);
                    dialog.create().show();
