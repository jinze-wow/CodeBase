...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="">计科男生宿舍管理系统</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><img src="/images/timg.jpg" class="layui-nav-img">${sessionScope.ad.a_username}</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
...
<%--                o_span--%>
                <span class="o_span">${sessionScope.ad.a_username}管理员，欢迎来到铁大计科男生宿舍管理系统！</span>
                <div class="layui-col-md6" style="padding: 10px;left: 60px;background-color: #F2F2F2;">
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">©2021 石家庄铁道大学</div>
</div>
<!-- 底部结束 -->
