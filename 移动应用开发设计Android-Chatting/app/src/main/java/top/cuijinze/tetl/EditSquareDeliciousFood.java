...
public class EditSquareDeliciousFood extends AppCompatActivity {
        ...
        publish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(content!=null && type!=null){
                    AlertDialog.Builder dialog = new AlertDialog.Builder(EditSquareDeliciousFood.this)
                            ...
                            .setPositiveButton("发布", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    /*定义进度条对话框*/
                                    ProgressDialog ProDialog = new ProgressDialog(EditSquareDeliciousFood.this);
                            ...
                            .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(EditSquareDeliciousFood.this,"取消发布，重新编辑",Toast.LENGTH_SHORT).show();
                                }
                            })
                            .setCancelable(false);
                    dialog.create().show();
